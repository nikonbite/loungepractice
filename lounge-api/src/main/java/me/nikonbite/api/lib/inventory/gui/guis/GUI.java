...
import me.nikonbite.api.lib.inventory.gui.contents.GUIContentsProvider;
import me.nikonbite.api.lib.inventory.gui.contents.GUIPopulator;
import me.nikonbite.api.lib.inventory.gui.elements.GUIElement;
import me.nikonbite.api.lib.inventory.gui.events.*;
...
import me.nikonbite.api.lib.inventory.gui.view.GUIPresenter;
import me.nikonbite.api.lib.inventory.plugin.EventCaller;
import me.nikonbite.api.lib.inventory.util.GUISettingValidation;
...
public class GUI implements InventoryGUI {
    ...
    public void open(final Player player, int page) {
        ...
        guiPopulator.populateGUI(session, player, param -> {
    ...
    protected void updateContentsAndView(final Player player, final GUISession session) {
        ...
        guiPopulator.populateGUI(session, player, param -> updateView(player, session));
    }
