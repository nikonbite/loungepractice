...
import me.nikonbite.api.lib.inventory.gui.contents.PaginatingGUIContentsProvider;
...
public class GUIBuilder {
    ...
    public GUIBuilder contents(final String title, final List<GUIElement> elements,
        ...
        if (title.length() > GUIContentsProvider.MAX_TITLE_LENGTH) {
            throw new IllegalArgumentException("GUI Title too long for Minecraft! Max length is " + GUIContentsProvider.MAX_TITLE_LENGTH);
        }
        if (elements == null) {
